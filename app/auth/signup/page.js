        ...
        >
          ...
          >
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} className="custom-formlabel">
                <FormControlLabel
                  control={
                  ...
                  sx={{ marginRight: "-5px" }}
                />
                <span style={{ fontSize: "12px", letterSpacing: "-0.6px" }}>
            ...
            <Grid container justifyContent="center" sx={{ marginTop: 4 }}>
              <Grid item>
                ...
                <Link href="./login" variant="body2" className="account_link">
                  Login
                </Link>
              </Grid>
            </Grid>
